...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 mb-5">
      <div class="card">
        <div class="position-absolute px-3 py-2 bg-dark bg-opacity-75"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }} </a></div>
